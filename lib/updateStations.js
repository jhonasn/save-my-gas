...
var getWeekCode = function (date) {
    var startDateMillis = new Date(1999, (6-1), 13).valueOf()
...
var thisIsDate = function(o) {
    return o && typeof o === 'string' && o.length >= 10
}

var dateStringToDate = function(o) {
    if(thisIsDate(o)) {
        var o = o.split('/')
...
module.exports.anpUpdated = function (cb) {
    ...
    var reduceByDate = function(a, b) {
        if(thisIsDate(a.dataColeta) && thisIsDate(b.dataColeta)) {
            var aDate = dateStringToDate(a.dataColeta)
            var bDate = dateStringToDate(b.dataColeta)
    ...
    lastUpdatedDate = dateStringToDate(lastUpdatedDate)
    ...
    module.getCaptcha(greatCities[0], new Date(), function(err, values) {
        ...
        async.parallel(citiesFunc, function(err, res) {
            ...
            var anpLastUpdated = dateStringToDate(updatedStation.dataColeta)
...
module.getCaptcha = function(city, diaSemana, cb) {
    ...
    module.post(
        'http://www.anp.gov.br/preco/prc/Resumo_Por_Municipio_Index.asp', {
            cod_Semana: getWeekCode(diaSemana),
...
module.exports.postProcessStations = function(cb) {
	...
	var formatStationObj = function (station) {
		...
		var fuelTypeName = toPropName(fuelType.name)
        ...
        if(station.dataColeta) {
            station[fuelTypeName].dataColeta = dateStringToDate(station.dataColeta)
            delete station.dataColeta
        }
        if(station.dataRecusa) {
            station[fuelTypeName].dataRecusa = dateStringToDate(station.dataRecusa)
