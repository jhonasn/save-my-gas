...
module.exports.get = function(cb, getFailedStations) {
	if(entity.readStationsFiles()) {
		...
		stations.forEach(function(station, i) {
			var params = null
			if(station.geolocation && station.geolocation.search && station.geolocation.search.components) {
				params = station.geolocation.search
			} else {
