...
var updateStations = require(path.resolve(rootPath, 'lib', 'anpStations', 'get.js'))
var stationsTransform = require(path.resolve(rootPath, 'lib', 'anpStations', 'transform.js'))
