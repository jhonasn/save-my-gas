...
module.menu = function(cb) {
	...
	console.log('[i] to manually insert geolocation')
...
module.insertGeolocation = function() {
	module.clearConsole()

	console.log('Selected station: \n', module.stringJsonColor(module.stations.current()), '\n\n')
	rl.question('insert gelocation as {lat,lng} (without the braces): ', function(geolocation) {
