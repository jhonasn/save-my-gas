...
eval mkdir -p "./res/icon ./res/screen"
eval mkdir -p "./res/icon/android"
eval mkdir -p "./res/icon/ios"
eval mkdir -p "./res/icon/wp8"

eval mkdir -p "./res/screen/android"
eval mkdir -p "./res/screen/ios"
eval mkdir -p "./res/screen/wp8"
