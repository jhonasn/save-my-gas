...
.factory('geolocationService',
	function(
		...
		return {
			distanceBetween: function(geolocationA, geolocationB) {
				var geoA = new GeoPoint({
					lat: geolocationA.lat,
					lng: geolocationA.lng
				})

				var geoB = new GeoPoint({
					lat: geolocationB.lat,
					lng: geolocationB.lng
				})

				return GeoPoint.distanceBetween(geoA, geoB, { type: 'kilometers' })
			}
		}
	})
