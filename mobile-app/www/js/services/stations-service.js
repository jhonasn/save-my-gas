...
function(
	...
	var stationsService = {
		...
		getDistanceStations: function(destinationsPoints) {
				...
				.success(function(dataDist) {
					...
					if (dataDist.status == 'OK') {
						...
						for (var i = 0; i < module.stations.length; i++) {
							...
							} else if (module.vehicle.unit.value == module.ConverterServices.consumption.units.kpl.value) {
								module.stations[i].fuelSpend = module.ConverterServices.distance.distanceLitersConsumption.apply(null, distanceParams)
							} else if (module.vehicle.unit.value == module.ConverterServices.consumption.units.mpg.value) {
								module.stations[i].fuelSpend = module.ConverterServices.distance.distanceGalonsConsumption.apply(null, distanceParams)
							} else if (module.vehicle.unit.value == module.ConverterServices.consumption.units.mpgus.value) {
								module.stations[i].fuelSpend = module.ConverterServices.distance.distanceGalonsUsConsumption.apply(null, distdistanceParams)
							} else {
        ...
        */
		...
		get: function(radius, vehicle, nextPage) {
		...
		constructor: function($http, $q, ConverterServices) {
			module.$q = $q
			module.$http = $http
			module.ConverterServices = ConverterServices
