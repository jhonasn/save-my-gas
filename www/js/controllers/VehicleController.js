define(function(){
  ...
  module.VehicleCtrl = function($scope, $state, $ionicPopup, crud, converters) {
  ...
  module.VehicleEditCtrl = function($scope, $state, $stateParams, crud, converters) {
    ...
    $scope.vehicleType = [
      { id: 1, name: 'car', img: 'default-car.png' },
      { id: 2, name: 'motocycle', img: 'default-moto.png' },
      { id: 3, name: 'truck', img: 'default-truck.png' },
      { id: 3, name: 'van', img: 'default-van.jpg' },
    ]
  ...
  module.VehicleCtrl.$inject = ['$scope', '$state', '$ionicPopup', 'crud', 'converters']
  module.VehicleEditCtrl.$inject = ['$scope', '$state', '$stateParams', 'crud', 'converters']
